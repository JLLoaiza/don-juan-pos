...
const app = buildApi({ database: asDatabaseHealth(pool), auth: createSqlAuthService(pool, authSecret), catalog: new CatalogService(pool), floor: new FloorService(pool), corsOrigins });
