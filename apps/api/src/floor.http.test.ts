...
const context = { user: { id: "00000000-0000-4000-8000-000000000001", displayName: "Admin" }, branches: [branch], activeBranch: branch, permissions: ["dining_areas.view", "tables.view", "accounts.open", "accounts.view", "accounts.update", "sales.add_items", "kitchen.send"] };
...
const floor = { floor: vi.fn(async () => ({ diningAreas: [], tables: [] })), account: vi.fn(), openAccount: vi.fn(async () => ({ id: "00000000-0000-4000-8000-000000000099" })), confirmConsumption: vi.fn() };
